...
export default function Hero() {
  return (
    <div className="relative min-h-screen bg-white flex flex-col justify-between pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full flex-grow grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start lg:items-center pt-12 sm:pt-16 lg:pt-6 pb-16 lg:pb-28">
        ...
        <div className="lg:col-span-6 space-y-4 sm:space-y-6">
          ...
          <motion.h1
            ...
            className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[68px] font-extrabold tracking-tight text-[#0B0D12] leading-[1.1]"
          >
            Move Ahead. <br />
            With Confidence. <br />
            <span className="font-caveat text-[32px] sm:text-[40px] md:text-[46px] lg:text-[56px] text-[#2D509F] relative inline-block mt-2 sm:mt-3 font-normal select-none pr-4">
              With SGA Motors.
              <svg 
          ...
          <motion.p
            ...
            className="text-neutral-grey text-sm sm:text-base md:text-lg max-w-xl leading-relaxed font-medium"
          >
          ...
          >
            <a
              href="#cars"
              className="flex items-center justify-center gap-2 bg-[#2D509F] hover:bg-[#1e3a75] text-white font-bold px-5 sm:px-7 py-3 sm:py-3.5 rounded-full transition-all duration-200 shadow-md shadow-blue-500/10 text-sm sm:text-base"
            >
            ...
            <a
              href="#book"
              className="flex items-center justify-center gap-2 bg-white border border-[#2D509F] text-[#0B0D12] font-bold px-5 sm:px-7 py-3 sm:py-3.5 rounded-full hover:bg-blue-50/20 transition-all duration-200 shadow-sm text-sm sm:text-base"
            >
        ...
        <div className="lg:col-span-6 relative hidden lg:flex min-h-[300px] md:min-h-[400px] items-center justify-center lg:justify-end">
